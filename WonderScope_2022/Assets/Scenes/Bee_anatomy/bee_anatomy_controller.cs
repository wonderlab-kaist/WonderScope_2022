...
public class bee_anatomy_controller : MonoBehaviour
{
    ...
    {
        Transform org = organ_points[num];
        Cam.transform.position = new Vector3(org.transform.position.x, org.transform.position.y, org.transform.position.z -10);
        findByName(org.name);
    }
